...
import ModeratorLoginComp from '../../Components/Login/ModeratorLoginComp'
...
function ModeratorLogin() {
  return (
    <div>
        <ModeratorLoginComp renderDropdown={(currentPage,onNavigate)=><Dropdown currentPage={currentPage} onNavigate={onNavigate} />}/>
    </div>
  )
}
