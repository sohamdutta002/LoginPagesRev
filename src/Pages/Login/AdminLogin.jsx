...
import AdminLoginComp from '../../Components/Login/AdminLoginComp'
...
function AdminLogin() {
  return (
    <div>
        <AdminLoginComp renderDropdown={(currentPage,onNavigate)=><Dropdown currentPage={currentPage} onNavigate={onNavigate} />}/>
    </div>
  )
}
